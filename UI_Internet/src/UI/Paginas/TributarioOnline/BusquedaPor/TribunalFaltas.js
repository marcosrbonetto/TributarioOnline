...
//Componentes
import TributarioAccessTribunalFalta from '@Componentes/TributarioAccessTribunalFalta';
      ...
      <div className={classes.mainContainer}>
        <Grid container className={classes.root} spacing={16} justify="center">
          <Grid item xs={4} classes={{ "grid-xs-4": "tributarioAccess" }} >
            <TributarioAccessTribunalFalta
              idTipoTributo={1}
              regexFormato={/^[a-zA-Z]{3}[0-9]{3}|[a-zA-Z]{2}[0-9]{3}[a-zA-Z]{2}$/}
              titulo="Automotores"
